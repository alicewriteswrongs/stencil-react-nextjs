...
const createElm = (e, t, o, n) => {
 ...
 let a, r, i, d = 0;
 if (!useNativeShadowDom && (checkSlotRelocate = !0, "slot" === l.$tag$ && (l.$flags$ |= l.$children$ ? 2 : 1)), null !== l.$text$) a = l.$elm$ = doc.createTextNode(l.$text$); else if (1 & l.$flags$) a = l.$elm$ = slotReferenceDebugNode(l) ; else {
  if (a = l.$elm$ = doc.createElement(2 & l.$flags$ ? "slot-fb" : l.$tag$), 
  updateElement(null, l), 
  l.$children$) for (d = 0; d < l.$children$.length; ++d) r = createElm(e, l, d), 
  r && a.appendChild(r);
 }
 ...
 null !== r ? (i = n["s-cr"]) ? i.parentNode.textContent = r : e.$text$ !== r && (n.data = r) : ((updateElement(e, t)), null !== s && null !== l ? ((e, t, o, n, s = !1) => {
  ...
  patch(p, f, s), e.insertBefore(p.$elm$, m.$elm$), p = t[--$], f = n[++i]; else {
   ...
   d >= 0 ? (a = t[d], a.$tag$ !== f.$tag$ ? l = createElm(t && t[i], o, d) : (patch(a, f, s), 
   t[d] = void 0, l = a.$elm$), f = n[++i]) : (l = createElm(t && t[i], o, i), f = n[++i]), 
 ...
 if ($.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = c.$elm$ = i, 
