...
/*!
 Stencil Mock Doc v4.17.0-dev.1713889831.1426d0e | MIT Licensed | https://stenciljs.com
 */
...
var registerStyle = (scopeId2, cssText, allowCS) => {
  ...
  console.log("about to set, scope id", scopeId2, "style", style);
...
var initializeComponent = async (elm, hostRef, cmpMeta, hmrVersionId) => {
  ...
  if ((hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
    ...
    if (Cstr.style) {
      ...
      console.log("about to register style", style);
...
const myComponentCss = ":host{display:block;background-color:red}";
...
class MyComponent {
    ...
    render() {
        return hAsync("div", { key: '5452c3b9c97f8879dbc26b788d1fa79409846ff0' }, "Hello, World! I'm ", this.getText());
    }
...
/*
 Stencil Hydrate Runner v4.17.0-dev.1713889831.1426d0e | MIT Licensed | https://stenciljs.com
 */
var __defProp = Object.defineProperty;
var __export = (target, all) => {
  for (var name in all)
